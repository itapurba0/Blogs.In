...
import { useMyBlogs , useUser } from '../hooks/Index';
...
export const MyBlogs = () => {
  ...
  const authorAbout = user?.aboutMe || 'Passionate blogger, content creator, and storyteller.';
  const authorBio = user?.bio || 'I believe in writing stories that resonate with readers and inspire people to think beyond the ordinary.';
  ...
  return (
    ...
    <div className="pt-16 pb-10 px-6 md:px-10 lg:px-28">
      {blogs.length === 0 ? (
        <div className="h-screen max-w-7xl mx-auto flex flex-col gap-12 lg:gap-20 mt-10 justify-center items-center">
